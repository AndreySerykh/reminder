import {modalWin, createReminderWindowContent, reminderItems, eventModWinView} from "../index.js"
  ...
  export class ReminderItem extends Element {
          ...
          if (e.which == 1) {
            ...
            if (this.mousePressTime < 1000) {
              ...
              if (!ReminderItem.checkModeState) {
                modalWin.create({
                  windowName: "view",
                  body: createReminderWindowContent("view", reminderItems[e.target.data]),
                  selectedReminderId: e.target.data,
                  event: eventModWinView,
                });
              }
            }
            this.mousePressTime = 0;
    ...
    static checkMode(state) {
      ...
      document
        ...
        .classList.toggle("block-invisible");
